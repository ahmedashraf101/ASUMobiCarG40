...
DrawCircleLeft();
 ...
 void Square(int speed , int duration) {
    //forward(speed,2000);
//    delay(2000);
    right(duration,speed-5,speed);
//    delay(2000);
    backward(speed/2,duration/2);
    delay(2000);
    right(duration,speed-5,speed);
//    delay(2000);
    backward(speed/2,duration/2);
...
void Circle(int speed , int duration,int direct) {
     if(direct == 0){
      right(100, 0.5 * speed, speed);
      backward(speed,150);
      delay(100);
     }
     else if(direct == 1){
       left(100, speed, 0.5 * speed);
      backward(speed,150);
      delay(100);
      }
//delay(100);
